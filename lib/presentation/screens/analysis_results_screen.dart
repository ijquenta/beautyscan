      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Collage de looks', style: TextStyle(fontFamily: 'Poppins', fontSize: 28, fontWeight: FontWeight.w700, color: Colors.black87, letterSpacing: -0.5)),
            const SizedBox(height: 8),
            const Text(
              'Generaremos una sola imagen con 4 variaciones de peinado basadas en tu colorimetría.',
              style: TextStyle(fontFamily: 'Poppins', fontSize: 13, color: Colors.black54, height: 1.5),
            ),
            const SizedBox(height: 20),
            Row(
              children: [
                Icon(Icons.auto_awesome_rounded, size: 14, color: Colors.black.withValues(alpha: 0.35)),
                const SizedBox(width: 8),
                const Text('1 generación de IA · 1 imagen collage 2×2', style: TextStyle(fontFamily: 'Poppins', fontSize: 11, color: Colors.black45)),
              ],
            ),
            const SizedBox(height: 8),
            Row(
              children: [
                Icon(Icons.check_circle_outline, size: 14, color: Colors.black.withValues(alpha: 0.35)),
                const SizedBox(width: 8),
                const Text('4 estilos diferentes en un solo resultado', style: TextStyle(fontFamily: 'Poppins', fontSize: 11, color: Colors.black45)),
              ],
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Center(
                  child: Text('Generar collage', style: TextStyle(fontFamily: 'Poppins', fontSize: 13, fontWeight: FontWeight.w600, color: Colors.white)),
                ),
              ),
            ),
          ],
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, size: 22, color: outlined ? Colors.black54 : Colors.white),
            ),
